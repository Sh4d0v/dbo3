...
public partial class InventoryItem : SlotItem
{
    ...
    /// <summary>
    /// Override the Render method to draw the rarity outline
    /// </summary>
    ...
    /// <summary>
    /// Draw colored outline (border) around the item.
    /// </summary>
